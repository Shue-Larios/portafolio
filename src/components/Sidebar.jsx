...
export const Sidebar = () => {
    return (
        <>
            ...
            <div className="fixed top-1/2 left-0 transform -translate-y-1/2  text-white w-auto py-5">
                <ul>
                    <li className="mb-2">
                        <a href="https://www.facebook.com/Shue.Larios"
                            title='Facebook'
                            className="block px-4 py-2 hover:bg-gray-700">
                            <svg loading="lazy" width="26" height="26" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li className="mb-2">
                        <a href="https://github.com/Shue-Larios"
                            title='GitHub'
                            className="block px-4 py-2 hover:bg-gray-700">
                            <svg loading="lazy" width="26" height="26" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li className="mb-2">
                        <a href="https://www.instagram.com/shue_larios/"
                            title='Instagram'
                            className="block px-4 py-2 hover:bg-gray-700">
                            <svg
                                loading='lazy'
